...
<%@ Page Language="C#" CodeBehind="WF1Init.aspx.cs" Inherits="WF1.WF1Init" MasterPageFile="~masterurl/default.master" %>
            ...
            <wssuc:InputFormControl Runat="server" LabelText="Specify which positions should review and approve the agenda documents:">
                <Template_Control>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>Expedite this workflow</td>
                            <td><asp:CheckBox ID="chkExpedited" runat="server" OnCheckedChanged="chkExpeditedChanged" AutoPostBack="True" /> </td>
                        </tr>
                    </table>
                    <br/>
                    ...
                    <asp:Panel id="pnlExpedited" runat="server" visible="false">
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td colspan="4">
                                This workflow will send the documents for Approval to the GM. You can select it to be sent to the DGM and/or the CBSS for a review first.
                            </td>
                        </tr>
                        <tr height="20px">
                            <td colspan="4">
