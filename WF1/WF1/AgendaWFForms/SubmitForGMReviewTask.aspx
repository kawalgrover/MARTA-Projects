...
<%@ Page Language="C#" CodeBehind="SubmitForGMReviewTask.aspx.cs" Inherits="WF1.SubmitForGMReviewTask" MasterPageFile="~masterurl/default.master" %>
             ...
             <td valign="top">
                ...
                <table border="0" width="100%">
                 ...
                 <table cellspacing="0" cellpadding="4" border="0" width="100%">
                     <tr>
                         <td>
                             <asp:Button Text="Submit for GM Review" runat="server" ID="btnSubmitForApproval" />
                         </td>
