...
<%@ Page Language="C#" CodeBehind="ReviewerTaskForm.aspx.cs" Inherits="WF1.ReviewerTaskForm" MasterPageFile="~masterurl/default.master" %>
                 ...
                 <table cellspacing="0" cellpadding="4" border="0" width="100%">
                     <tr>
                         ...
                         <td nowrap="nowrap" class="ms-vb">
                             <asp:Button Text="No Response" runat="server" ID="btnNoResponse" />
                         </td>
                         <td nowrap="nowrap" class="ms-vb">
