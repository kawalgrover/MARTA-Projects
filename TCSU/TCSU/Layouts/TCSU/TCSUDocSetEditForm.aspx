...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TCSUDocSetEditForm.aspx.cs" Inherits="TCSU.Layouts.TCSU.TCSUDocSetEditForm" DynamicMasterPageFile="~masterurl/default.master" %>
                                 ...
                                 <table  border="0"  cellspacing="0"  width="100%"> 
                                    <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_Letter"  ControlMode="Edit"  FieldName="Letter"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                            <SharePoint:FormField  runat="server"  ID="field_Transmittal"  ControlMode="Edit"  FieldName="Transmittal"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_SubmittalDate"  ControlMode="Edit"  FieldName="SubmittalDate"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_ReviewDueDate"  ControlMode="Edit"  FieldName="ReviewDueDate"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_SubmittalType"  ControlMode="Edit"  FieldName="SubmittalType"  /> 
                                     ...
                                     <tr class="invisible"> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_Release"  ControlMode="Edit"  FieldName="Release"  /> 
                                     ...
                                     <tr class="invisible"> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_Revision"  ControlMode="Edit"  FieldName="Revision"  /> 
                                     ...
                                     <tr class="invisible"> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                            <SharePoint:FormField  runat="server"  ID="field_SectionFunction"  ControlMode="Edit"  FieldName="SectionFunction"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_Discipline"  ControlMode="Edit"  FieldName="Discipline"  /> 
                                     ...
                                     <tr class="invisible"> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                            <SharePoint:FormField  runat="server"  ID="field_LocationVehicle"  ControlMode="Edit"  FieldName="LocationVehicle"  /> 
