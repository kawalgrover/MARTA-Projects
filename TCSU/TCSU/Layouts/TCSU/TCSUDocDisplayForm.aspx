...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TCSUDocDisplayForm.aspx.cs" Inherits="TCSU.Layouts.TCSU.TCSUDocDisplayForm" DynamicMasterPageFile="~masterurl/default.master" %>
                                 ...
                                 <table  border="0"  cellspacing="0"  width="100%"> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_Name"  ControlMode="Display"  FieldName="Name"  /> 
