...
<%@ Page Language="C#" CodeBehind="SubmitForDGMReviewTask.aspx.cs" Inherits="WF1.SubmitForDGMReviewTask" MasterPageFile="~masterurl/default.master" %>
             ...
             <td valign="top">
                ...
                <table border="0" width="100%">
                 ...
                 <table cellspacing="0" cellpadding="4" border="0" width="100%">
                     <tr>
                         <td>
                             <asp:Button Text="Submit for CBSS/DGM Review" runat="server" ID="btnSubmitForApproval" />
                         </td>
