...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TodaysMeetingsUserControl.ascx.cs" Inherits="PaperlessBoard_Board_Webparts.TodaysMeetings.TodaysMeetingsUserControl" %>
