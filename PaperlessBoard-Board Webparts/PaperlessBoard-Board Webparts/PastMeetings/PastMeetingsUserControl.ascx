...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PastMeetingsUserControl.ascx.cs" Inherits="PaperlessBoard_Board_Webparts.PastMeetings.PastMeetingsUserControl" %>
