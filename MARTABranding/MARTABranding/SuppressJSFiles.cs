...
namespace MARTABranding.WebControls
{
    /// <summary>
    ...
    /// in the FilesToSuppress property (a semi-colon separated list). This control *must* be placed before the main OOTB ScriptLink control 
    /// (Microsoft.SharePoint.WebControls.ScriptLink) in the 
