...
<%@ Page Language="C#" CodeBehind="DigitalSignaturesInit.aspx.cs" Inherits="PBWorkflows.DigitalSignaturesInit" MasterPageFile="~masterurl/default.master" %>
...
<asp:Table CellSpacing="0" CellPadding="0" BorderWidth="0" CssClass="ms-propertysheet">
    <wssuc:InputFormSection Title="Digital Signatories" Description="The following individuals will be notified to digitally sign the documents." runat="server">
                ...
                <Template_Control>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                       ...
                       <asp:GridView ID="gvContributors" runat="server" AutoGenerateColumns="false" ShowHeader="true">
                            <Columns>
                                <asp:BoundField DataField="SignatoryName" HeaderText="Signatory" />
                            </Columns>
                       </asp:GridView>
...
Initiate Digital Signatures Workflow
</asp:Content>
