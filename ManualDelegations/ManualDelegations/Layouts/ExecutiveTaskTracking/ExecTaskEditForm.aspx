...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExecTaskEditForm.aspx.cs" Inherits="ExecutiveTaskTracking.Layouts.ExecutiveTaskTracking.ExecTaskEditForm" DynamicMasterPageFile="~masterurl/default.master" %>
                                 ...
                                 <table  border="0"  cellspacing="0"  width="100%"> 
                                    <tr> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                            <SharePoint:FormField  runat="server"  ID="field_HighPriority"  ControlMode="Edit"  FieldName="HighPriority"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_DelegateTo"  ControlMode="Edit"  FieldName="DelegateTo"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_DelegateDueDate"  ControlMode="Edit"  FieldName="DelegateDueDate"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_ActionRequired"  ControlMode="Edit"  FieldName="ActionRequired"  /> 
