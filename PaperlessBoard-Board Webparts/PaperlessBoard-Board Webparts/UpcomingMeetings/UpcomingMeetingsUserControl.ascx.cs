...
{
    public partial class UpcomingMeetingsUserControl : UserControl
    {
        ...
        private void GetUpcomingMeetings()
        {
            using (SPSite boardSite = new SPSite(boardSiteURL))
            {
                using (SPWeb boardRootWeb = boardSite.OpenWeb())
                {
                    ...
                    {
                        if ((DateTime.Parse(meeting["EventDate"].ToString()).Date < meetingDate.Date)
                            && (DateTime.Parse(meeting["EventDate"].ToString()).Date > DateTime.Today) )
                        {
