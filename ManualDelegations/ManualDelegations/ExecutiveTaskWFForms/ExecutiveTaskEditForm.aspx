...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExecutiveTaskEditForm.aspx.cs" Inherits="ExecutiveTaskTracking.ExecutiveTaskEditForm" MasterPageFile="~masterurl/default.master" %>
             ...
             <td valign="top">
                ...
                <table border="0" width="100%">
                 ...
                 <table cellspacing="0" cellpadding="4" border="0" width="100%">
                     <tr>
                         <td>
                             <asp:Button Text="Complete" runat="server" ID="btnApprove" />
                         </td>
                         <td>
                             <asp:Button Text="Comments Added" runat="server" ID="btnReject" Visible="false" />
                         </td>
