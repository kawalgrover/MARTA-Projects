...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TCSUDocEditForm.aspx.cs" Inherits="TCSU.Layouts.TCSU.TCSUDocEditForm" DynamicMasterPageFile="~masterurl/default.master" %>
                         ...
                         <td> 
                                 <table  border="0"  cellspacing="0"  width="100%"> 
                                     ...
                                     <tr class="invisible"> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="field_AlstomDocumentNumber"  ControlMode="Edit"  FieldName="AlstomDocumentNumber"  /> 
                                     ...
                                     <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                           <SharePoint:FormField  runat="server"  ID="field_CDRLList"  ControlMode="Edit"  FieldName="CDRLList"  /> 
