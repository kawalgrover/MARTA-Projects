...
<%@ Page Language="C#" CodeBehind="NotifiyContributorsInit.aspx.cs" Inherits="PBWorkflows.NotifiyContributorsInit" MasterPageFile="~masterurl/default.master" %>
...
<asp:Table CellSpacing="0" CellPadding="0" BorderWidth="0" CssClass="ms-propertysheet">
    <wssuc:InputFormSection Title="Content Contributors" Description="The following individuals will be notified to add content." runat="server">
            ...
            <wssuc:InputFormControl Runat="server" LabelText="">
                <Template_Control>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                       ...
                       <asp:GridView ID="gvContributors" runat="server" AutoGenerateColumns="false" ShowHeader="true">
                        <Columns>
                            <asp:BoundField DataField="ContributorName" HeaderText="Contributor Name" />
                        </Columns>
                       </asp:GridView>
...
Content Contributors Workflow
</asp:Content>

<asp:Content ID="PageTitleInTitleArea" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server" >
Initiate Content Contributors Workflow
</asp:Content>
